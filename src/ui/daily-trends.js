...
function barChart(model,definition){
  ...
  return`<div class="trend-scroll"><svg class="trend-chart" role="group" aria-label="${definition.label}最近 ${model.days} 天趋势图" width="${width}" height="190" viewBox="0 0 ${width} 190">${bars}</svg></div>`;
}
