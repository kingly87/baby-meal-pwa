...
test('startup loads active baby and scoped data', async () => {
  const repo=new MemoryRepository({babies:[{id:'b1',name:'柚柚'}],appSettings:[{id:'global',activeBabyId:'b1'}],taskInstances:[{id:'t2',babyId:'b1',status:'upcoming',plannedAt:'2026-07-20T12:00:00Z'},{id:'t1',babyId:'b1',status:'upcoming',plannedAt:'2026-07-20T10:00:00Z'}]});
