...
test('service worker has safe caching, navigation fallback and controlled updates', async () => {
  ...
  assert.ok(sw.includes("const CACHE_NAME='baby-growth-v1-20260720-r8'"));
  ...
  const appFiles=['./','./index.html','./assets/styles/app.css','./data/recipes.js','./src/app.js','./src/features/meals/recipe-details.js','./src/features/migration/v2.js','./manifest.webmanifest'];
